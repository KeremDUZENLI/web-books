...
- **Design Implication:** Counter-intuitively, while sensitivity to _scene motion_ decreases as head motion speed increases, sensitivity to _latency_ increases with faster head motion. Fast movements make lag more apparent.
