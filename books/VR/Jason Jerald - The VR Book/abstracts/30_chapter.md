...
- **Definition:** The methodology of quickly testing many implementations and continually improving upon them based on data, rather than attempting to "perfectly design" a solution upfront.
- **Design Implication:** VR designers must accept that their intuition is often wrong. The only way to find what is useful (whether realistic or magical) is to build it, test it with users, and analyze the results.
...
- **Definition:** The threat posed by team members who are close-minded to other disciplines or user feedback.
- **Design Implication:** Because VR is inherently cross-disciplinary, a programmer who refuses to listen to design input (or vice versa) acts as "cancer" to the project. Such individuals must be warned or removed immediately to preserve the project's health.
...
- Ideally, subject-matter experts should learn VR limitations, and VR experts should learn the problem domain. If a team member refuses to learn from others, they become a hindrance. The guide explicitly advises removing such members to prevent the failure of the experience.
