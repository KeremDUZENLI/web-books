...
- **Definition:** The user's journey through the narrative, which relies heavily on the user's imagination to fill in gaps (as demonstrated by the Heider and Simmel shape experiment).
- **Design Implication:** Content creators should focus on leading the mind through suggestion rather than presenting every detail. Using **skeuomorphism** (familiar real-world metaphors) helps users transition to new interactions by lowering the learning curve.
...
- **Definition:** The essential moment-to-moment activity where users make meaningful choices resulting in meaningful feedback (e.g., the act of hitting the ball in ping-pong).
- **Design Implication:** This is the foundation of the application. If the core experience is not pleasurable on its own, adding features (gamification, graphics) will not sustain long-term engagement.

**Conceptual Integrity**

- **Definition:** The consistency, coherence, and uniformity of style within a project.
- **Design Implication:** To achieve this, a single director should ideally control the vision, acting as the final decision-maker to prevent a "mishmash" of incompatible good ideas.
...
- **Definition:** The perceptual separation of an object (figure) from its background (ground). Figures have distinct forms and ownership of borders, while the ground acts as a stable reference (rest frame).
- **Design Implication:** Convex, familiar, and lower-placed shapes are more likely to be seen as figures. Designers use this to indicate which objects are interactive signifiers.
